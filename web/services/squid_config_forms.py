...
def _resolve_range_offset_limit_value(tunables: TunableMap, _max_workers: int) -> str:
    if tunables.get("range_offset_limit_value") is not None:
        return _normalize_range_offset_limit_value(
            tunables.get("range_offset_limit_value"),
        )
...
CONFIG_FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    _field(
        ...
        _posted_choice_reader(
            "store_dir_select_algorithm",
            allowed=("least-load", "round-robin"),
            default="least-load",
        ),
    ...
    _field(
        ...
        help_text="Requires persistent client connections. Leave off unless you specifically benefit from HTTP pipelining; Squid documents auth breakage risks for NTLM and Negotiate/Kerberos.",
    ),
    _field(
    ...
    _field(
        ...
        "read_ahead_gap",
        "number",
        _tunable_or_default_if_none("read_ahead_gap_kb", 16),
    ...
    _field(
        ...
        "quick_abort_min",
        "number",
        _tunable_or_default_if_none("quick_abort_min_kb", 16),
    ...
    _field(
        ...
        "quick_abort_max",
        "number",
        _tunable_or_default_if_none("quick_abort_max_kb", 16),
    ...
    _field(
        ...
        "quick_abort_pct",
        "number",
        _tunable_or_default_if_none("quick_abort_pct", 95),
    ...
    _field(
        ...
        "caching",
        "heuristics",
        "Convert reloads into IMS revalidation",
        "reload_into_ims",
        "checkbox",
        _tunable_bool_or_default("reload_into_ims", False),
        _checkbox_reader("reload_into_ims_on"),
        help_text="Treat client reload/no-cache requests as If-Modified-Since revalidations. Leave off unless you intentionally want reloads to preserve cache efficiency despite Squid documenting this as an HTTP-violating compatibility feature.",
    ),
    _field(
    ...
    _field(
        ...
        "connect_timeout",
        "number",
        _tunable_or_default_if_none("connect_timeout_seconds", 60),
    ...
    _field(
        ...
        "number",
        _tunable_or_default_if_none("request_start_timeout_seconds", 300),
    ...
    _field(
        ...
        "request_timeout",
        "number",
        _tunable_or_default_if_none("request_timeout_seconds", 300),
    ...
    _field(
        ...
        "read_timeout",
        "number",
        _tunable_or_default_if_none("read_timeout_seconds", 900),
    ...
    _field(
        ...
        "forward_timeout",
        "number",
        _tunable_or_default_if_none("forward_timeout_seconds", 240),
    ...
    _field(
        ...
        "number",
        _tunable_or_default_if_none("server_idle_pconn_timeout_seconds", 60),
    ...
    _field(
        ...
        "client_lifetime",
        "number",
        _tunable_or_default_if_none("client_lifetime_seconds", 24 * 3600),
    ...
    _field(
        ...
        "buffered_logs",
        "checkbox",
        _tunable_bool_or_default("buffered_logs", False),
        _checkbox_reader("buffered_logs_on"),
        help_text="Can reduce log I/O overhead for non-stdio access_log modules, but delays log availability and increases loss risk.",
    ),
    _field(
        "log_mime_hdrs_on",
        "logging",
    ...
    _field(
        ...
        "connect_retries",
        "number",
        _tunable_or_default_if_none("connect_retries", 0),
    ...
    _field(
        ...
        "forward_max_tries",
        "number",
        _tunable_or_default_if_none("forward_max_tries", 25),
    ...
    _field(
        ...
        "dns_timeout",
        "number",
        _tunable_or_default_if_none("dns_timeout_seconds", 30),
    ...
    _field(
        ...
        "dns_packet_max",
        "text",
        _tunable_or_default_if_none("dns_packet_max", 1232),
        _posted_text_reader("dns_packet_max"),
        placeholder="1232 or none",
        help_text="Advertised EDNS UDP size. 1232 is a modern low-fragmentation baseline; use 'none' to disable EDNS.",
    ),
    _field(
        "dns_nameservers",
        "dns",
    ...
    _field(
        ...
        "icap",
        "controls",
        "Enable ICAP adaptation",
        "icap_enable",
        "checkbox",
        _tunable_bool_or_default("icap_enable", True),
        _checkbox_reader("icap_enable_on"),
        help_text="Master switch for Squid-side ICAP request/response adaptation.",
    ),
    _field(
        "icap_206_enable_on",
        "icap",
        "controls",
        "Enable ICAP 206 partial-content support",
        "icap_206_enable",
        "checkbox",
        _tunable_bool_or_default("icap_206_enable", True),
        _checkbox_reader("icap_206_enable_on"),
        help_text="Allow ICAP services that understand 206 Partial Content to combine adapted and original body data.",
    ...
    _field(
        ...
        "icap",
        "controls",
        "Forward authenticated username to ICAP services",
        ...
        help_text="Adds authenticated usernames to ICAP requests when Squid knows them.",
        depends_on=("icap_enable_on",),
        show_when=("checked",),
    ),
    _field(
        ...
        "icap",
        "controls",
        "ICAP username header name",
        "icap_client_username_header",
        "text",
        _tunable_or_default_if_none("icap_client_username_header", "X-Client-Username"),
        _posted_text_reader("icap_client_username_header"),
        help_text="Header name Squid uses for forwarded authenticated usernames. Only used when username forwarding is enabled.",
        depends_on=("icap_enable_on", "icap_send_client_username_on"),
    ...
    _field(
        ...
        "icap",
        "controls",
        "Base64-encode forwarded usernames",
        "icap_client_username_encode",
        "checkbox",
        _tunable_bool_or_default("icap_client_username_encode", False),
        _checkbox_reader("icap_client_username_encode_on"),
        help_text="Encode authenticated usernames before sending them to ICAP services.",
        depends_on=("icap_enable_on", "icap_send_client_username_on"),
        show_when=("checked", "checked"),
    ),
    _field(
    ...
    _field(
        ...
        "icap",
        "controls",
        "Enable ICAP preview negotiation",
        "icap_preview_enable",
        "checkbox",
    ...
    _field(
        ...
        "icap_preview_size",
        "number",
        _tunable_or_default_if_none("icap_preview_size_kb", 128),
        _posted_int_reader("icap_preview_size_kb"),
        minimum=0,
        step=1,
        help_text="Maximum preview data offered to ICAP services. Smaller previews reduce download latency; raise only if the ICAP service needs more body data up front.",
    ...
    _field(
        ...
        "icap",
        "advanced",
        "Adaptation loop limit",
        "adaptation_service_iteration_limit",
        "number",
        _tunable_or_default_if_none("adaptation_service_iteration_limit", 16),
        _posted_int_reader("adaptation_service_iteration_limit"),
        minimum=1,
        step=1,
        help_text="Maximum number of adaptation service passes before Squid treats a transaction as looping.",
        depends_on=("icap_enable_on",),
        show_when=("checked",),
    ),
    _field(
        ...
        "icap",
        "advanced",
        "Upload continuation rules",
        "force_request_body_continuation",
        "textarea",
        _tunable_or_default_if_none("force_request_body_continuation_rules_text", ""),
        _posted_multiline_reader("force_request_body_continuation_rules_text"),
        rows=6,
        placeholder="force_request_body_continuation allow all",
        help_text="Enter full `force_request_body_continuation ...` lines, one per line, if you want Squid to proactively send 100 Continue / FTP continue responses so uploads reach ICAP services sooner.",
        depends_on=("icap_enable_on",),
        show_when=("checked",),
    ),
    _field(
        "icap_retry_rules_text",
        "icap",
        "advanced",
        "ICAP retry rules",
        "icap_retry",
        "textarea",
        _tunable_or_default_if_none("icap_retry_rules_text", ""),
        _posted_multiline_reader("icap_retry_rules_text"),
        rows=6,
        placeholder="icap_retry allow all",
        help_text="Enter full `icap_retry ...` lines, one per line, to choose which retriable ICAP transactions Squid may retry.",
        depends_on=("icap_enable_on",),
        show_when=("checked",),
    ),
    _field(
        ...
        "icap_retry_limit",
        "number",
        _tunable_or_default_if_none("icap_retry_limit", 0),
        _posted_int_reader("icap_retry_limit"),
        minimum=0,
        step=1,
        help_text="Maximum number of ICAP retries allowed for transactions matched by icap_retry rules.",
        depends_on=("icap_enable_on",),
        show_when=("checked",),
    ),
    _field(
    ...
    _field(
        ...
        _posted_choice_reader(
            "uri_whitespace_mode",
            allowed=("strip", "deny", "allow", "encode", "chop"),
            default="strip",
        ),
    ...
    _field(
        ...
        "performance",
        "smp",
        "Hopeless worker restart backoff (seconds)",
        "hopeless_kid_revival_delay",
        "number",
        _tunable_or_default_if_none("hopeless_kid_revival_delay_seconds", 3600),
        _posted_int_reader("hopeless_kid_revival_delay_seconds"),
        minimum=1,
        step=1,
        help_text="How long Squid waits before reviving a repeatedly crashing worker after it is marked hopeless.",
    ),
    _field(
        "workers",
        "performance",
    ...
    _field(
        ...
        "performance",
        "guardrails",
        "Median response warning threshold (ms)",
        "high_response_time_warning",
        "number",
        _tunable_optional("high_response_time_warning_ms"),
        _posted_optional_int_reader("high_response_time_warning_ms"),
        minimum=1,
        step=1,
        help_text="Leave blank to disable cache.log warnings when the one-minute median response time exceeds this threshold.",
    ),
    _field(
        "high_page_fault_warning",
        "performance",
        "guardrails",
        "Page-fault warning threshold",
        "high_page_fault_warning",
        "number",
        _tunable_optional("high_page_fault_warning"),
        _posted_optional_int_reader("high_page_fault_warning"),
        minimum=1,
        step=1,
        help_text="Leave blank to disable cache.log warnings when the one-minute page-fault rate exceeds this threshold.",
    ),
    _field(
        "max_filedescriptors",
        "performance",
    ...
    _field(
        ...
        "number",
        _tunable_or_default_if_none("store_avg_object_size_kb", 13),
    ...
    _field(
        ...
        "store_objects_per_bucket",
        "number",
        _tunable_or_default_if_none("store_objects_per_bucket", 20),
    ...
    _field(
        ...
        "cache_mgr",
        "email",
        _tunable_or_default_if_none("cache_mgr_email", "proxy-admin@example.invalid"),
        _posted_string_reader("cache_mgr_email", default="proxy-admin@example.invalid"),
        placeholder="proxy-admin@example.invalid",
        help_text="Squid exposes this contact as %w on branded error pages so users know who to contact.",
    ),
    _field(
...
FORM_KIND_FIELD_SPECS["caching"] += (FIELD_MAP["workers"],)
...
CONFIG_UI_SECTIONS: tuple[UiSectionSpec, ...] = (
    ...
    UiSectionSpec(
        key="icap",
        label="ICAP",
        description="Adaptation enablement, metadata forwarding, previews, retries, and failure handling.",
        ...
        groups=(
            UiGroupSpec(
                key="controls",
                title="ICAP controls",
                description="Master ICAP toggles, client metadata forwarding, and connection reuse.",
                field_keys=(
                    "icap_enable_on",
                    "icap_206_enable_on",
                    "icap_send_client_ip_on",
            ...
            UiGroupSpec(
                key="advanced",
                title="Adaptation retries and uploads",
                description="Loop protection, retry policy, and upload continuation. Rule text areas expect full directive lines.",
                field_keys=(
                    "adaptation_service_iteration_limit",
                    "force_request_body_continuation_rules_text",
                    "icap_retry_rules_text",
    ...
    UiSectionSpec(
        key="performance",
        label="Performance",
        description="SMP sizing, warning thresholds, memory pools, file descriptors, and cache-index tuning.",
        ...
        groups=(
            ...
            UiGroupSpec(
                ...
                description="Optional cache.log warning thresholds for slow service times or excessive page faults.",
                field_keys=(
                    "high_response_time_warning_ms",
                    "high_page_fault_warning",
                ),
    ...
    UiSectionSpec(
        ...
        groups=(
            UiGroupSpec(
                ...
                description="How Squid names itself, exposes user support contact, and handles some Vary edge cases.",
                field_keys=(
                    "visible_hostname",
                    "cache_mgr_email",
                    "httpd_suppress_version_string_on",
...
def build_template_options(tunables: TunableMap, *, max_workers: int) -> dict[str, Any]:
    options = {
        field.key: field.resolver(tunables, max_workers) for field in CONFIG_FIELDS
    }
...
def parse_cache_override_form(form: FormMap) -> dict[str, bool]:
    ...
    for field in CACHE_OVERRIDE_FIELDS:
        ...
        legacy_on = any(
            form.get(legacy_field) == "on"
            for legacy_field in _LEGACY_CACHE_OVERRIDE_FORM_FIELDS.get(field, ())
        )
