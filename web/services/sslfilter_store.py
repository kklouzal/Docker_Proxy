...
class SslFilterStore:
    ...
    def render_materialized_state(self) -> SslFilterMaterializedState:
        ...
        if nobump_domains:
            ...
            lines.append("note ssl_exception sslfilter_nobump_domains sslfilter_nobump_domain")
        ...
        if nocache_domains:
            ...
            lines.append("note cache_bypass sslfilter_nocache_domains sslfilter_nocache_domain")
