...
CLAMAV_FIELDS: tuple[ClamavFieldSpec, ...] = (
    ...
    _field(
        ...
        "text",
        help_text="Amount of response data c-icap should receive before early-send begins. Default 2M keeps small objects fully buffered until scanned while still allowing progress on large downloads.",
        placeholder="2M",
    ),
    _field(
...
def render_virus_scan_config(options: Mapping[str, Any] | None = None) -> str:
    ...
    lines = [
        ...
        "",
        "# Stream limited partial content while scanning continues; keep SendPercentData below 100.",
