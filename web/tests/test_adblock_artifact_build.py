...
def test_adblock_artifacts_do_not_expose_legacy_local_runtime_apply() -> None:
    artifacts_module = _import_adblock_artifacts_module()

    assert not hasattr(artifacts_module, "apply_active_artifact_locally")
    assert not hasattr(artifacts_module, "_restart_local_adblock_service")
